...
public class GamePanel extends JPanel implements Runnable{ // Make a JPanel class with extra functionalities
	...
	public int currentMap = 0; // Map index
	...
	public Entity obj[][] = new Entity[maxMap][20]; // 20 slots for objects
	...
	if(gameState == playState) {
		...
		for(int i = 0; i < monster[1].length; i++) {
			if(monster[currentMap][i] != null) {
				if(monster[currentMap][i].alive == true || monster[currentMap][i].dying == true) {
