...
public class Player extends Entity{
	...
	public void attack() {
		...
		if(spriteTimer > 5 && spriteTimer <= 25) { // Between 6 ~ 25 frames show image 2
			...
			int projectileIndex = gp.coll.checkEntityCollision(this, gp.projectile);
			counterProjectile(projectileIndex);
	...
	public void equipItem() {
		int itemIndex = gp.ui.getInventoryItemIndex(gp.ui.playerSlotCol, gp.ui.playerSlotRow);
	...
	public void counterProjectile(int i) {
